...
LOGO_TRADEMARK_URL_PNG = ENV_TOKENS.get('LOGO_TRADEMARK_URL_PNG', LOGO_TRADEMARK_URL_PNG)
LOGO_TRADEMARK_URL_SVG = ENV_TOKENS.get('LOGO_TRADEMARK_URL_SVG', LOGO_TRADEMARK_URL_SVG)

LOGO_URL = ENV_TOKENS.get('LOGO_URL', LOGO_URL)
LOGO_URL_PNG = ENV_TOKENS.get('LOGO_URL_PNG', LOGO_URL_PNG)
LOGO_URL_SVG = ENV_TOKENS.get('LOGO_URL_SVG', LOGO_URL_SVG)

LOGO_WHITE_URL = ENV_TOKENS.get('LOGO_WHITE_URL', LOGO_WHITE_URL)
LOGO_WHITE_URL_PNG = ENV_TOKENS.get('LOGO_WHITE_URL_PNG', LOGO_WHITE_URL_PNG)
LOGO_WHITE_URL_SVG = ENV_TOKENS.get('LOGO_WHITE_URL_SVG', LOGO_WHITE_URL_SVG)
